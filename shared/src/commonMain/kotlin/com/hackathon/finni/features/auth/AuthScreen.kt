...
import com.hackathon.finni.resources.auth_action_register
...
import com.hackathon.finni.resources.auth_no_account_prompt
import com.hackathon.finni.resources.auth_password_label
import com.hackathon.finni.resources.auth_subtitle
        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(Res.string.auth_no_account_prompt),
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                    TextButton(onClick = viewModel::onRegisterClick) {
                        Text(stringResource(Res.string.auth_action_register))
                    }
                }
            }
        }
